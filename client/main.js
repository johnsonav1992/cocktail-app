...
function addFavorite(e) {
    let listItemLength = e.target.parentNode.parentNode.children[7].children.length;
    ...
    let drinkId = e.target.parentNode.parentNode.parentNode.children[1].children[2].id;
    let drinkLetter = e.target.parentNode.parentNode.parentNode.children[1].children[0].innerHTML
        .charAt(0)
        .toLowerCase();
    let drinkName = e.target.parentNode.parentNode.parentNode.children[1].children[0]
        .innerHTML;
    let drinkObj = {
        id: drinkId,
        name: drinkName,
...
function deleteFavorite(drinkId) {
    axios
        ...
        for (let i = 0; i < favoritesBox?.children.length; i++) {
            ...
            if (drinkToDelete?.getAttribute('id') === String(drink.drinkId)) {
